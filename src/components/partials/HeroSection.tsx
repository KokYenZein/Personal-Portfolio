    ...
    <div className="hero relative -mt-16 flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        <div className="overflow-hidden rounded-full">
          <Image src="/images/avatar/self-portrait.webp" width={250} height={250} alt="avatar" />
        </div>
        <h1 className="mt-4 text-3xl font-bold ">Yen Zein Kok</h1>
        <div className="mt-2 flex gap-1">
          {' '}
          I'm a{' '}
          <Typed
            strings={['Data Engineer', 'Data Scientist', 'Data Analyst']}
            typeSpeed={60}
            backSpeed={30}
            loop
          />
        ...
        <div className="mt-4  flex gap-5">
          <Link href="https://github.com/KokYenZein">
            <a className="text-gray-700 transition-colors duration-150 hover:text-primary-500">
              <FiGithub size={25} />
            </a>
          </Link>

          <Link href="https://www.linkedin.com/in/yenzein/">
            <a className="text-gray-700 transition-colors duration-150 hover:text-primary-500">
              <FiLinkedin size={25} />
            </a>
          </Link>
