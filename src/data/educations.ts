...
export const educations: Education[] = [
  {
    ...
    'Introduction to Combinatorics', 'Introduction to Mathematical Logic', 'Introduction to Computational Mathematics', 
...

  {
    ...
    I majored in Mathematics and Computer Science and was awarded the Dean’s List for 2 semesters.`,
